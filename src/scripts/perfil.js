function draw_profile(){
    ...
    if (nombre_usuario !== null && nombre_usuario !== "") {
        ...
        if (cancion_favorita_mp3 !== null && cancion_favorita_mp3 !== "" && cancion_favorita_mp3 !== undefined) {
            ...
            cancion_favorita_name = cancion_favorita[0]
            pagina_perfil_left_html.innerHTML = pagina_perfil_left_html.innerHTML + `<p style="margin-left: 15px;">Cancion favorita: ${cancion_favorita_name}</p><div id=${cancion_favorita_mp3}><img class="perfil_col_left_song" src="images/${cancion_favorita_image}"></div>`
        }
        ...
        if (escuchando_ahora_mp3 !== null && escuchando_ahora_mp3 !== "" && escuchando_ahora_mp3 !== undefined) {
            ...
            escuchando_ahora_name = escuchando_ahora[0]
            pagina_perfil_left_html.innerHTML = pagina_perfil_left_html.innerHTML + `<p style="margin-left: 15px;">Escuchando ahora: ${escuchando_ahora_name}</p><div id=${escuchando_ahora_mp3}><img class="perfil_col_left_song" src="images/${escuchando_ahora_image}"></div>`
        }
